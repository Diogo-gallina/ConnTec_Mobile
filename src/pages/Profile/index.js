    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        <TouchableOpacity style={[styles.containerMensage, { marginTop: 20 }]}>
          <Image
            style={styles.iconMensage}
            source={require("../../../assets/iconM.png")}
          />
          <Text style={styles.titleMensage}> MENSAGE </Text>
          <Text style={styles.remententeMensage}>
            {" "}
            Cesar Adriano de Freitas
          </Text>
          <Text style={styles.mensage}>
            {" "}
            Sent you in 2hr at Etec do Taboão.
          </Text>
        ...
        <TouchableOpacity style={styles.containerMensage}>
          ...
          <Text style={styles.mensage}>
            {" "}
            Sent you in 24hr at Etec do Taboão.
          </Text>
        ...
        <TouchableOpacity style={styles.containerMensage}>
          ...
          <Text style={styles.mensage}>
            {" "}
            Sent you in 12hr at Etec do Taboão.
          </Text>
        ...
        <TouchableOpacity style={styles.containerMensage}>
          ...
          <Text style={styles.mensage}>
            {" "}
            Sent you in 22hr at Etec do Taboão.
          </Text>
...
const styles = StyleSheet.create({
  ...
  containerfunc: {
    //container dos buttons settings/notificações
    flexDirection: "row",
    alignSelf: "center",
    marginTop: 20,
    bottom: 10,

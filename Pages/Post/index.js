...
import {View, StyleSheet, Image, TouchableOpacity, ScrollView, Text} from 'react-native'; //importando componentes
      ...
      <ScrollView>
        ...
        >
          ...
          <View>             
            ...
            <Image source={require('../../assets/icon.jpg')} style={styles.imageUser} resizeMode='center'></Image>
              <Text style={[styles.txt, { marginLeft:60, bottom:30}]}>Gisele@</Text>
              <Text style={[styles.txt, { marginLeft:70, fontWeight:'600', color:'green', bottom:30}]}> Xbox Favorite!! </Text>
          </View>
          ...
          <View>
            ...
            <View style={styles.description}>
              <Text style={styles.txt}>Bottom line: Xbox Series X is Microsoft's best Xbox console yet, sporting powerful and bold hardware that won't disappoint.</Text>
            </View>
          </View>
        </View>  
        ...
        <View style={{bottom:100}}>             
            ...
            <View style={styles.containerTitlePost}>
            <Image source={require('../../assets/icon2.jpg')} style={styles.imageUser} resizeMode='center'></Image>
              <Text style={[styles.txt, { marginLeft:60, bottom:30}]}>CesarAa</Text>
              <Text style={[styles.txt, { marginLeft:70, fontWeight:'600', color:'green', bottom:30}]}> Xbox Favorite!! </Text>
          </View>

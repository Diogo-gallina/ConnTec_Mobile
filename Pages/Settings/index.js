  ...
  <View style={styles.container}>
      ...
      <View style={[styles.containerMain, {marginTop:'7%'}]}>
        <View style={[styles.containerFunc, {marginTop:'5%'}]}>
          ...
          <View style={[styles.icons, {backgroundColor:'#b20000'}]}>
            <MaterialCommunityIcons style={{alignSelf:'center', marginTop:'10%'}}name="theme-light-dark" size={20} color="white" />
          </View>  
        ...
        <View style={[styles.containerFunc, {marginTop:'5%'}]}>
          ...
          <View style={[styles.icons, {backgroundColor:'#b20000'}]}>
            <MaterialCommunityIcons style={{alignSelf:'center', marginTop:'10%'}}name="bell" size={20} color="white" />
          </View>
      ...
      <View style={[styles.containerMain, {marginTop:'15%'}]}>
        <TouchableOpacity style={[styles.containerFunc, {marginTop:'5%'}]}>
          ...
          <View style={[styles.icons, {backgroundColor:'#b20000'}]}>
            <Ionicons style={{alignSelf:'center', marginTop:'10%'}}name="document" size={20} color="white" />
        </View>  
